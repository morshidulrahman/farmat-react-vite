...
function Search() {
    return (
        <>
            <div className='bg-gray-100 rounded-md xl:min-w-[40%] hidden md:flex p-4 mx-4 items-center gap-3 w-auto'>
                ...
                <input
                    ...
                    className='outline-none  bg-transparent flex-1 border-l border-l-gray-300 pl-4'
                />
